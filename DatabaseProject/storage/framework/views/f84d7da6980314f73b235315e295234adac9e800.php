...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="<?php echo e(url('Frontend/img/fav.png')); ?>">
	<!-- Author Meta -->
	...
	<!--CSS============================================= -->
	<link rel="stylesheet" href="<?php echo e(url('Frontend/css/linearicons.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('Frontend/css/font-awesome.min.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('Frontend/css/themify-icons.css')); ?>">
	...
	<link rel="stylesheet" href="<?php echo e(url('Frontend/css/nice-select.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('Frontend/css/nouislider.min.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('Frontend/css/ion.rangeSlider.css')); ?>" />
	<link rel="stylesheet" href="<?php echo e(url('Frontend/css/ion.rangeSlider.skinFlat.css')); ?>" />
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="<?php echo e(url('home')); ?>"><img src="<?php echo e(url('Frontend/img/logo1.png')); ?>" alt=""></a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></span></a>
                            </li>
                            <?php if(Route::has('register')): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('register')); ?>"><?php echo e(__('Register')); ?></span></a>
                                </li>
                            <?php endif; ?>
                        	<?php else: ?>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="nav-item">
								...
								?>
								<a href="<?php echo e(url('cart')); ?>" class="cart">
									<span class="ti-bag"></span>
									<?php if(!empty($barang_cust)): ?>
									<div class="badge badge-danger"><?php echo e($barang_cust); ?></div>
									<?php endif; ?>
								</a>
								<?php else: ?>
								<a href="<?php echo e(url('cart')); ?>" class="cart"><span class="ti-bag"></span></div></a>
								<?php endif; ?>
							</li>
                        </ul>
					</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!-- End footer Area -->
    <script src="<?php echo e(url('Frontend/js/vendor/jquery-2.2.4.min.js')); ?>"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4"
	 crossorigin="anonymous"></script>
	<script src="<?php echo e(url('Frontend/js/vendor/bootstrap.min.js')); ?>"></script>
	<script src="<?php echo e(url('Frontend/js/jquery.ajaxchimp.min.js')); ?>"></script>
	<script src="<?php echo e(url('Frontend/js/jquery.nice-select.min.js')); ?>"></script>
	<script src="<?php echo e(url('Frontend/js/jquery.sticky.js')); ?>"></script>
	<script src="<?php echo e(url('Frontend/js/nouislider.min.js')); ?>"></script>
	<script src="<?php echo e(url('Frontend/js/countdown.js')); ?>"></script>
	...
	<script src="<?php echo e(url('Frontend/js/gmaps.min.js')); ?>"></script>
	<script src="<?php echo e(url('Frontend/js/main.js')); ?>"></script>  
	<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
	<?php echo $__env->make('sweet::alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\DatabaseProject\resources\views/layouts/app.blade.php ENDPATH**/ ?>