				...
				<div class="col-lg-12">
					<div class="active-banner-slider owl-carousel">
						...
						<div class="row single-slide">
							...
							<div class="col-lg-7">
								<div class="banner-img">
									<img class="img-fluid" src="{{url ('Frontend/img/banner/banner-img1.png') }}" alt="">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							...
							<div class="product-details">
								...
								<div class="price">
								<h6><strong>IDR {{ number_format($barang->harga_barang) }}</strong></h6>
								</div>
								<div class="prd-bottom">

									<a href="{{ url('detail') }}/{{ $barang->id }}" class="social-info">
				...
				<div class="col-lg-6 no-padding exclusive-right">
					<div class="active-exclusive-product-slider">
						...
						<div class="single-exclusive-slider">
							...
							<div class="product-details">
								<div class="price">
									<h6>IDR {{number_format(1499000)}}</h6>
								</div>
